...
export default function Hero() {
  return (
    <div className="hero flex flex-col justify-center items-center text-center py-20 px-4 bg-linear-to-b from-amber-300 via-amber-400 to-amber-500">
